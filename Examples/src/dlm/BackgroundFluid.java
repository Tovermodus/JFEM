...
public class BackgroundFluid
	extends SingleGridFluid
{
	private final double density;
	private final double reynold;
	
	public BackgroundFluid(final CoordinateVector startCoordinates,
	                       ...
	                       final double renold)
	{
		super(startCoordinates, endCoordinates, cells, polynomialDegree);
