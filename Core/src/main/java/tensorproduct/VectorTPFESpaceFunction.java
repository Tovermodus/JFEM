...
public class VectorTPFESpaceFunction<ST extends VectorShapeFunction<TPCell, TPFace>> extends VectorFESpaceFunction<ST> implements FunctionOnCells<TPCell, TPFace, CoordinateVector, CoordinateMatrix, CoordinateTensor>
{
