...
public class ContinuousIntegralTest
{
	...
	public void testTPCellIntegralDeg1G3() {
		...
		TPCellIntegral<ContinuousTPShapeFunction> gg = new TPCellIntegral<>(TPCellIntegral.GRAD_GRAD);
		TPCellIntegral<ContinuousTPShapeFunction> ggw = new TPCellIntegral<>(weight,TPCellIntegral.GRAD_GRAD,false);
		TPCellIntegral<ContinuousTPShapeFunction> vg = new TPCellIntegral<>(vweight,TPCellIntegral.VALUE_GRAD,false);
		TPCellIntegral<ContinuousTPShapeFunction> gv = new TPCellIntegral<>(vweight,TPCellIntegral.GRAD_VALUE,false);
		TPCellIntegral<ContinuousTPShapeFunction> vv = new TPCellIntegral<>(TPCellIntegral.VALUE_VALUE);
		TPCellIntegral<ContinuousTPShapeFunction> vvw = new TPCellIntegral<>(weight,TPCellIntegral.VALUE_VALUE,false);
		int k = 0;
